		...
		<div className="max-w-3xl mx-auto py-8">
			...
			<div className="mb-24">
				...
				<Section title="Saved">
					<Endpoint
						method="GET"
						path="/saved/:userAddress"
						description="Get all saved writers and entries for a user."
						params={[
							{
								name: "userAddress",
								type: "address",
					...
					<Endpoint
						method="POST"
						path="/saved/:userAddress/writer/:address"
						description="Save a writer."
						params={[
							{
								name: "userAddress",
								type: "address",
					...
					<Endpoint
						method="POST"
						path="/saved/:userAddress/entry/:id"
