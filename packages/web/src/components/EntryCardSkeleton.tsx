export function EntryCardSkeleton() {
	return (
		<div className="aspect-square bg-surface flex flex-col px-2 pt-2 pb-0.5 overflow-hidden">
			...
			<div className="flex items-end justify-between text-sm leading-3 pt-2 shrink-0 pb-2">
				<div className="h-3.5 w-3.5 bg-surface-raised animate-pulse rounded" />
				<div className="h-3 bg-surface-raised animate-pulse rounded w-20" />
			</div>
		</div>
	);
}
