		...
		>
			<ReactMarkdown
				...
				components={{
					...
					a: ({ children, href }) => <a href={href} className="mdx--link">{children}</a>,
					strong: ({ children }) => <strong className="mdx--textBold">{children}</strong>,
					em: ({ children }) => <em className="mdx--textItalic">{children}</em>,
					code: ({ children }) => <code className="mdx--textCode">{children}</code>,
