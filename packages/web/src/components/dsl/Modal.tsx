		...
		<Dialog.Root open={open} onOpenChange={onClose}>
			<Dialog.Portal>
				...
				<Dialog.Content
					...
					className={cn(
						"DialogContent",
						"fixed top-1/2 left-1/2 z-[101] transform -translate-x-1/2 -translate-y-1/2 w-80vw max-w-450px max-h-85vh p-[25px] bg-neutral-200 dark:bg-neutral-800 rounded-xl",
						className,
					)}
				>
					{children}
