...
ALTER TABLE "writer" ADD CONSTRAINT "writer_transaction_id_relay_tx_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."relay_tx"("id") ON DELETE no action ON UPDATE no action;